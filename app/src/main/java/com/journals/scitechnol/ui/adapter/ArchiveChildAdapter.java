...
import com.journals.scitechnol.databinding.ArchiveChildListItemBinding;
...
public class ArchiveChildAdapter extends RecyclerView.Adapter<ArchiveChildAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ArchiveChildAdapter.ViewHolder holder, int position) {
        ...
        holder.rowItemBinding.txtArchiveChildName.setText(modelList.get(position).getValume());
        ...
        holder.rowItemBinding.getRoot().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("month",modelList.get(position).getMonth());
                bundle.putString("journal",modelList.get(position).getJournal());
                bundle.putString("ActionBarTitle",modelList.get(position).getValume());
