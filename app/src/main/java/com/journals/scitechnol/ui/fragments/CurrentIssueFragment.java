...
import com.journals.scitechnol.databinding.FragmentCurrentIssueBinding;
import com.journals.scitechnol.model.CurrentIssueResponse;
import com.journals.scitechnol.ui.adapter.CurrentIssuesAdapter;
import com.journals.scitechnol.ui.viewmodel.CurrentIssueViewModel;
...
public class CurrentIssueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (bundle != null) {
            journalcode = getArguments().getString("journal");
        ...
        currentIssueViewModel.init(journalcode,requireActivity());
        ...
        currentIssueViewModel.getCurrentIssueRepository().observe(getViewLifecycleOwner(), homeResponse -> {
            ...
            if (homeResponse.isStatus()) {
                ...
                currentIssuesAdapter = new CurrentIssuesAdapter(catDetailsBeanList,requireActivity());
                fragmentCurrentIssueBinding.recyclerCurrentIssueList.setAdapter(currentIssuesAdapter);
